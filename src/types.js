...
export const ELEMENT_CANCELSELECTED = "ELEMENT_CANCELSELECTED";
export const ELEMENT_SAVED = "ELEMENT_SAVED";
export const FIELDCODE_FETCHED = "FIELDCODE_FETCHED";
export const OPTION_FETCHED = "OPTION_FETCHED";
export const FIELDCODES_FETCHED = "FIELDCODES_FETCHED";
